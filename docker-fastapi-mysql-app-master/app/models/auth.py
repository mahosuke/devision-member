...
class AuthModel(AbstractModel):
    ...
    def create_user(self, username, password, family_id):
        """
        新規ユーザ作成
        :param username: ユーザ名
        ...
        sql = "INSERT INTO users(username, password, family_id) VALUE (%s, %s ,%s);"
        self.execute(sql, username, hashed_password, family_id)
